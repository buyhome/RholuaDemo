...
#define SWIG_init    Init_Rholua
#define SWIG_name    "Rholua"

static VALUE mRholua;
...
extern "C"
#endif
SWIGEXPORT void Init_Rholua(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mRholua = rb_define_module("Rholua");
  ...
  rb_define_module_function(mRholua, "native_process_string", _wrap_native_process_string, -1);
  rb_define_module_function(mRholua, "calc_summ", _wrap_calc_summ, -1);
}
